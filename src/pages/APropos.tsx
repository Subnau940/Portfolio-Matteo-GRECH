          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-center gap-2 transition-all duration-200 hover:translate-x-2">
        ...
        <div className="glass-card rounded-3xl p-8 animate-scale-in">
          ...
          <div className="flex flex-wrap gap-3">
            {loisirs.map((loisir, index) => (
              <span key={index} className="px-4 py-2 bg-gradient-to-r from-primary/10 to-warm-500/10 text-warm-700 rounded-2xl text-sm font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer">
                {loisir}
              </span>
            ))}
          </div>
