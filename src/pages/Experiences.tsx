...
const Experiences = () => {
  const experiences = [
    {
      ...
      description: "Support et supervision d'une infrastructure réseau nationale pour des points de vente (supermarchés, etc.).",
      missions: [
  ...
  const typeConfig: Record<string, { label: string; color: string; icon: React.ElementType }> = {
    alternance: { label: "Alternance", color: "bg-green-500 text-white", icon: Building2 },
    stage: { label: "Stage", color: "bg-primary text-primary-foreground", icon: GraduationCap },
    job: { label: "Job d'été", color: "bg-warm-500 text-white", icon: Briefcase },
  }
